...
const OTPVerification = () => {
    ...
    const handleVerify = async (e) => {
        ...
        try {
            ...
            setMessage(data.message);
            if (data.success) {
                router.push('/components/forget-pass');
            }
        } catch (error) {
            console.log(error);
        }
    ...
    return (
        <div className="h-screen flex flex-col items-center py-12 sm:px-6 lg:px-8 text-[#d31158]">
            ...
            <div className="mt-8 max-sm:mx-auto w-[370px] max-sm:w-[330px] bg-[#420a1f] z-10">
                <div className={`bg-transparent backdrop-blur-xl py-8 px-4 shadow sm:rounded-lg sm:px-10 relative ${loading ? 'pointer-events-none' : 'pointer-events-auto'}`}>

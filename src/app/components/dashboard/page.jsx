    ...
    return (
        user ? (
            <div className={`w-full h-screen flex items-start justify-center gap-x-4 relative ${loading ? 'pointer-events-none' : 'pointer-events-auto'} text-white`}>
                ...
                {
                    message && (
                        <p className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-red-500 px-4 py-1 z-40">
                            {message}
                        </p>
                    )
                }
                {
                    loading && (
                        <div className='absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 size-36 flex items-center justify-center rounded-full z-40'>

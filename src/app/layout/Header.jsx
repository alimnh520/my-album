            ...
            <div className={`flex items-center justify-center gap-x-14 max-sm:items-start max-sm:gap-x-0 max-sm:gap-y-3 overflow-hidden transition-all duration-300 z-10 max-sm:w-full`}>
                <ul className='flex items-center justify-center gap-x-9 font-semibold max-sm:w-full max-sm:justify-between'>
                    ...
                    <li>
                        {
                            user ? (
                                <Link href="/components/dashboard" className={`flex items-center text-3xl ${pathName === '/components/dashboard' && 'text-white'}`} onClick={() => setShowMenu(false)}>
                                ...
                                <Link href='/components/login' className={`flex items-center text-3xl ${pathName === '/components/login' && 'text-white'}`} onClick={() => setShowMenu(false)}><LuUserRound /></Link>
                            )
                        }
                    </li>
                </ul>
